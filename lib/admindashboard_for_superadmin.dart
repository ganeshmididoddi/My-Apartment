...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: admindashboard_for_superadmin(),
    );
  }
}
class admindashboard_for_superadmin extends StatefulWidget {
  String name;
  String code;
  String r_id;
  admindashboard_for_superadmin({this.name,this.code,this.r_id});
  @override
  _admindashboard_for_superadminState createState() => _admindashboard_for_superadminState(name,code,r_id);
}
class  constants{
...
class _admindashboard_for_superadminState extends State<admindashboard_for_superadmin> {
  DateTime time;
  String name;
  String code;
  String r_id;
  _admindashboard_for_superadminState(this.name,this.code,this.r_id);

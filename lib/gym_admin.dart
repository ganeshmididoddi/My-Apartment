...
class gym_admin extends StatefulWidget {
  String type;
  String r_id;
  String code;
  String name;
  String amenities_type;
  gym_admin({this.type,this.r_id,this.code,
  this.name,this.amenities_type});
  @override
  _gym_adminState createState() => _gym_adminState(type,r_id,code,name,amenities_type);
}

class _gym_adminState extends State<gym_admin> {
  String type;
  String r_id;
  String code;
  String value;
  String name;
  String amenities_type;
  _gym_adminState(this.type,this.r_id,this.code, this.name,this.amenities_type);
                        ...
                        RaisedButton(
                          onPressed: () {
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => new addamenities(r_id: r_id,code: code,id: amenities_id,
                                ...
                                amenities_type: "GYM",open:"edit_amenities")));
                          },
                          color: Colors.redAccent,
                          child: Text(
                            'Edit',
